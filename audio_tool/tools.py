...
import audio_tool.stft as stft
import audio_tool.hparams_audio as hparams
from audio_tool.audio_processing import griffin_lim
...
def inv_mel_spec(mel, out_filename, griffin_iters=60):
    ...
    audio = griffin_lim(torch.autograd.Variable(spec_from_mel[:, :, :-1]), _stft.stft_fn, griffin_iters)
